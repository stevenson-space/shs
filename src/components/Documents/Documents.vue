...
import FormCard from "common/cards/FormCard.vue";
import FormCardElement from "common/cards/FormCardElement.vue";
				...
				"AP Physics C": [
					{
						...
						link:
							"https://mega.nz/file/YQsFBQDZ#RBbv8lY3W5zmRWml4izso4Ht3hvIs0DFP7d69HVgpqw",
					},
				],
				"AP Chemistry": [
					{

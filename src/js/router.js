...
const GpaCalculator = () => import(/* webpackChunkName: "gpacalculator" */ "src/components/GpaCalculator/GpaCalculator.vue");
...
const Links = () =>
	import(/* webpackChunkName: "links" */ "src/components/Links/Links.vue");
const Colors = () =>
	import(/* webpackChunkName: "colors" */ "src/components/Colors/Colors.vue");
const Settings = () =>
	import(
		/* webpackChunkName: "settings" */ "src/components/Settings/Settings.vue"
	);
const Tools = () =>
	import(/* webpackChunkName: "tools" */ "src/components/Tools/Tools.vue");
const Documents = () =>
	import(
...
const Login = () =>
	import(/* webpackChunkName: "tools" */ "src/components/Login/Login.vue");
const routes = [
	{
		path: "/",
		component: Home

...
export const SpecialStationEntries = z.array(z.array(z.string()).length(WEEKDAYS_COUNT)).length(2);
...
export type SpecialStationEntries = z.infer<typeof SpecialStationEntries>;

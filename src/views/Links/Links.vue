  ...
  data() {
    return {
      links: [ /* eslint-disable max-len */
        ...
        { name: 'Patriot Dollars', desc: 'Patience Required', url: 'https://d125-sp.transactcampus.com/eaccounts/%28S%28hpb5gh0sgji4hrhmx2ymnvot%29%29/AnonymousHome.aspx', image: PatriotDollars }
      ],
    };
  },
};
